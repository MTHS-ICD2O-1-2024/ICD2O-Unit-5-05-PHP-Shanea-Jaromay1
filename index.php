      ...
      <div class="page-content">
        <form action="./answer.php" method="GET">
          ...
          <div class="mdl-textfield mdl-js-textfield">
            ...
            <label class="mdl-textfield__label" for="side-a">Enter number...</label>
          ...
          <div class="mdl-textfield mdl-js-textfield">
            ...
            <label class="mdl-textfield__label" for="side-b">Enter number...</label>
            <span class="mdl-textfield__error">Input is not a number!</span>
          </div>
          <br />
          <label>Side c: </label>
          <div class="mdl-textfield mdl-js-textfield">
            ...
            <label class="mdl-textfield__label" for="side-c">Enter number...</label>
            <span class="mdl-textfield__error">Input is not a number!</span>
          </div>
          <br />
      </div>
